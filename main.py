...
val_mat = model.predict_classes(X_test, verbose=VERBOSE)    # The matrix of outputs that the model infers
...
cnf_matrix = confusion_matrix(np.argmax(Y_test, axis=1), val_mat)   # Confusion matrix of correct and model-guessed values

print(cnf_matrix)   # Outputting the confusion matrix
